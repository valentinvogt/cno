...
def _load_dataset(dic, 
    ...
    if which == "ns_brownian":
        ...
        train_dataset =  BrusselatorEval(
                        ...
                        resolution = 128,
                        in_dist = True,
                        num_trajectories = 381 - 10 - 20,
                        data_path = "/cluster/scratch/vogtva/data/bruss/transfer",
                        time_input = dic["time_input"],
                        masked_input = masked_input,
                        allowed_transitions = dic["allowed_tran"])                                  
    else:
