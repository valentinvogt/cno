    ...
    with torch.no_grad():
        ...
        for step, batch in enumerate(testing_loader):
            ...
            for i, jump in enumerate(pattern):
                ...
                np.save(f'out/nrm/pred_pattern_{pattern_len}_batch_{step}_jump_{i}.npy', np_pred)
                np_out = out.cpu().numpy()
                np.save(f'out/nrm/out_pattern_{pattern_len}_batch_{step}_jump_{i}.npy', np_out)
