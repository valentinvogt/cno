...
if __name__ == "__main__":
    ...
    fine_tuned = False
    old_in_dim = 7  # PRETRAINING INPUT DIMENSION -- RELEVANT FOR FINETUNNING

    if not fine_tuned:

        # PROVIDE THE FOLDER WITH ALL THE MODELS FOR SCALING LAW::
        folders = "/cluster/scratch/vogtva/models/ft_cno_delayed"
        training_folder = None  # Keep it None

    else:
        # FOLDER OF THE FINETUNED MODEL:
        folders = "/cluster/scratch/vogtva/models/cno_delayed_2/FT_brusselator_eval"

        # FOLDER WHERE THE TRAINING DETAILS ARE (training_properties.txt file):
        training_folder = "/cluster/scratch/vogtva/models/cno_delayed_2"
