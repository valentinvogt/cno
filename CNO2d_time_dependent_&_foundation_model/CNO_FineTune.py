...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        "in_dim_tune": 7,      # If yes, what are they?
        "out_dim_tune": 6,
    ...
    in_dim = 7  # in_dim of the foudnarion model
    out_dim = 6 # out_dim of the foudnarion model
